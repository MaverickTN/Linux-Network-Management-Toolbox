...
from inetctl.core.netplan import get_vlan_subnets, get_base_interface_subnet
...
def generate_mangle_rules(config: Dict) -> str:
    ...
    qos_policies = gs.get("qos_policies", {}); header = ["# This file is auto-generated by inetctl.", "# Marks packets for Quality of Service.", "# ACTION\tSOURCE\t\tDEST"]; rules = []
    if qos_policies:
